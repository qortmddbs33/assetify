...
class NotionProperties {
  ...
  factory NotionProperties.fromJson(Map<String, dynamic> json) {
    return NotionProperties(
      ...
      status:
          NotionPropertyParser.asPlainString(json['사용/재고/폐기/기타']),
      ...
      shipmentStatus:
          NotionPropertyParser.asPlainString(json['출고진행상황']),
